...
public class HomeWork_Task5 {
	...
	/*	## Task5
		...
		*/
			...
			//              01234
//			String email = "dog@walmart.com";
//			String email1 = "dog1@walmart.com";
//			String email2 = "@walmart.com";
//			
...
//			
//			
//			System.out.println(email1.indexOf('2'));
//			System.out.println(email1.indexOf('1'));
//			System.out.println(email1.indexOf('0'));
//			System.out.println(email2.indexOf('0'));
//			
//			
			
		// The email string must contain an '@' character.
	//	 String email = "t@texample.in";	
